      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            ...
            unverbindliche Orientierung, während wir den konkreten Marktbedarf ermitteln.
          </p>
        </div>
            ...
            >
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-muted-foreground">/ Wh (Richtwert)</span>
                </div>
                <p className="text-sm text-muted-foreground mt-2">
                  Beispiel: 500 Wh Akku ≈{" "}
                  {(parseFloat(tier.pricePerWh.replace(",", ".")) * 500).toFixed(0)}€
                </p>
              </div>
        ...
        <div className="mt-12 p-6 rounded-xl bg-muted/50 max-w-4xl mx-auto">
          <p className="text-center text-muted-foreground">
            <strong className="text-foreground">Hinweis:</strong> Alle Angaben sind vorläufige
            Richtwerte. Die finalen Preise werden nach Abschluss der Bedarfsermittlung festgelegt.
          </p>
        </div>
      </div>
    </section>
